Public Class MouseHook
    ...
    Private Const WM_MOUSEWHEEL_CLICK As Integer = 526
    ...
    Public Event Mouse_Wheel_horizontal(ByVal ptLocat As Point, ByVal Direction As Wheel_Direction)

    Public Sub New()
        MouseHookDelegate = New MouseProcDelegate(AddressOf MouseProc)
        MouseHook = SetWindowsHookEx(WH_MOUSE_LL, MouseHookDelegate,
    ...
    Private Function MouseProc(ByVal nCode As Integer, ByVal wParam As Integer, ByRef lParam As MSLLHOOKSTRUCT) As Integer
        If (nCode = HC_ACTION) Then
            Select Case wParam
                ...
                Case WM_MOUSEWHEEL_CLICK
                    Dim wDirection As Wheel_Direction
                    If lParam.mouseData < 0 Then
                        wDirection = Wheel_Direction.WheelLeft
                    Else
                        wDirection = Wheel_Direction.WheelRight
                    End If
                    RaiseEvent Mouse_Wheel_horizontal(lParam.pt, wDirection)
            End Select
        End If
